...
public isolated class InternationalServiceRequestSourceConnect {

    *ServiceRequestSourceConnect;
    isolated function profile() returns r4:uri {
        return "http://hl7.org/fhir/StructureDefinition/ServiceRequest";
    }
    ...
    isolated function read(string id, r4:FHIRContext ctx) returns ServiceRequest|r4:FHIRError {
        ...
        if (res is http:ClientError) {
            ...
            if (payload is error) {
                ...
                r4:ServiceRequest|error fhirResource = payload.cloneWithType(r4:ServiceRequest);
        ...
        if (res is http:ClientError) {
            ...
            if (payload is error) {
                ...
                if (payload is json[]) {
                    ...
                    ServiceRequest[] fhirResources = [];
                    foreach var p in payloadArray {
                        r4:ServiceRequest|error fhirResource = p.cloneWithType(r4:ServiceRequest);
                        if (fhirResource is error) {
                            r4:FHIRError fhirError = r4:createFHIRError("Did not get a FHIR Resource from source.", r4:CODE_SEVERITY_ERROR, r4:TRANSIENT_EXCEPTION);
                            return fhirError;
                        } else {
