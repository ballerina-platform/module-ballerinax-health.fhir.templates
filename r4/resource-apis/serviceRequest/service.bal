...
isolated final map<ServiceRequestSourceConnect> profileImpl = {
    "http://hl7.org/fhir/StructureDefinition/ServiceRequest": new InternationalServiceRequestSourceConnect()
};
...
service http:InterceptableService / on new http:Listener(9090) {
    ...
    isolated resource function get fhir/r4/ServiceRequest(http:RequestContext ctx, http:Request request) returns @http:Payload {mediaType: [r4:FHIR_MIME_TYPE_JSON, r4:FHIR_MIME_TYPE_XML]} json|xml|r4:FHIRError|error {
    ...
    resource function get fhir/r4/ServiceRequest/[string id](http:RequestContext ctx) returns @http:Payload {mediaType: [r4:FHIR_MIME_TYPE_JSON, r4:FHIR_MIME_TYPE_XML]} json|xml|r4:FHIRError {
    ...
    resource function post fhir/r4/ServiceRequest(http:RequestContext ctx, http:Request request) returns @http:Payload {mediaType: [r4:FHIR_MIME_TYPE_JSON, r4:FHIR_MIME_TYPE_XML]} json|r4:FHIRError {
