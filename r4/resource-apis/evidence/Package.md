...
- Ballerina service for Evidence FHIR resource with following FHIR interactions.
- READ
- VREAD
- SEARCH
- CREATE
...
- Add profile type to the aggregated resource type. Eg: `public type Evidence r4:Evidence|<Other_Evidence_Profile>;`.
    ...
    - Eg: `profiles: ["http://hl7.org/fhir/StructureDefinition/synthesis", "new_profile_url"]`
