    ...
    isolated function read(string id, r4:FHIRContext ctx) returns Observation|r4:FHIRError {
        ...
        if (res is http:ClientError) {
            ...
            if (payload is error) {
                ...
                r4:Observation|error fhirResource = payload.cloneWithType(r4:Observation);
        ...
        if (res is http:ClientError) {
            ...
            if (payload is error) {
                ...
                if (payload is json[]) {
                    ...
                    Observation[] fhirResources = [];
                    foreach var p in payloadArray {
                        r4:Observation|error fhirResource = p.cloneWithType(r4:Observation);
                        if (fhirResource is error) {
                            r4:FHIRError fhirError = r4:createFHIRError("Did not get a FHIR Resource from source.", r4:CODE_SEVERITY_ERROR, r4:TRANSIENT_EXCEPTION);
                            return fhirError;
                        } else {
